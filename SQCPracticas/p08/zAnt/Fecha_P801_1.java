...
public Fecha_P801_1(int mes_param){
  this.asignarFecha();
  this.mes = mes_param;
}
...
public static void main (String[]args){
      ...
      Fecha_P801_1 FechaME = new Fecha_P801_1();
      int[]fecha = new int[3];
      FechaME.pedirFECHA();
      FechaME.obtenerFecha(fecha);
      Fecha_P801_1.amdFecha(fecha); //formato

      Fecha_P801_1 FechaME4 = new Fecha_P801_1();
      FechaME4.asignarFecha(7,10,1985);
      int[]fecha4 = new int[3];
      FechaME4.obtenerFecha(fecha4);
      Fecha_P801_1.amdFecha(fecha4); //formato

      Fecha_P801_1 FechaME2 = new Fecha_P801_1();
      FechaME2.asignarFecha();
      int[]return_fecha2 = new int[3];
      FechaME2.obtenerFecha(return_fecha2);
      Fecha_P801_1.amdFecha(return_fecha2); //formato

      Fecha_P801_1 FechaME3 = new Fecha_P801_1();
      FechaME3.asignarFecha(4);
      int []return_fecha3 = new int[3];
      FechaME3.obtenerFecha(return_fecha3);
      Fecha_P801_1.amdFecha(return_fecha3); //formato
